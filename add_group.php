...
function validate()
{
var x=document.forms["myForm"]["new_group"].value;
if (x==null || x=="")
{
...
if (flag=="This Groupname is already in use")
{
alert("Groupname is already in use");
return false;
}
} 
</script>
...
<div id="header">
	...
	<form action="group_save.php" method="post" id="myForm" onsubmit="return validate(this);">
		...
		<fieldset class="contact">
            ...
            <div>
               ...
               <textarea name="new_group"cols="30" rows="4" ></textarea><br /><br /><br />
