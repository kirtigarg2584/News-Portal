...
<div id="header">
	...
	<form action="news_edit_save.php" method="post" id="myForm" onsubmit="return validate()">
		
		
		<fieldset class="contact">
			<legend>Add News</legend>
            <div>
				<label for="news">Edit News</label> 
               <textarea name="news"cols="30" rows="4"><?php echo $news; ?></textarea>
			</div>
			
            </br></br></br></br></br>
            <input type="hidden" name="current_sno" id="current_sno" value="<?php echo $current_sno; ?>" />
			   <input type="hidden" name="active_date" id="active_date" value="<?php echo $active_date; ?>" />
               <input type="hidden" name="status_current" id="status_current" value="<?php echo $status_current; ?>" />
			<!--<div>
				<label for="email">Email</label> <input type="text" id="email" name="email" class="email">
			</div>-->
		</fieldset></br></br>

		<div>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Edit News" name="edit_news" id="edit_news" />
