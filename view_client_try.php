...
$query = "select customer_name,login_id,password,date_of_birth,charges,profile,uid,active_date,sno,DATEDIFF(expiry_date,'$currentdate') from add_client";
...
?>
							<tbody>
                                ...
                                <td align="center" width="15%"><?php echo $customer_name?></td>
                                 ...
                                 <td align="center" width="15%"><?php echo $profile?></td>
                                
                                <td align="center" width="15%"><?php echo $date_of_birth?></td>
                                ...
                                <td align="center" width="10%" bgcolor="#FFFFFF">
                                 <a href="client_edit.php?customer_name=<?php echo $customer_name?>&profile=<?php echo $profile?>&sno=<?php echo $id?>&date_of_birth=<?php echo $date_of_birth?>&charges=<?php echo $charges?>&renewal=<?php echo $renewal?>"  id="edit_button" name="edit_button">
                                <img src="image/icons/user_edit.png" title="Edit Client" width="16" height="16"/>
                                </a>

                               <a href="client_delete.php?customer_name=<?php echo $customer_name?>&profile=<?php echo $profile?>&sno=<?php echo $id?>&date_of_birth=<?php echo $date_of_birth?>&charges=<?php echo $charges?>" onClick="return confirm('Are you sure to delete this Client?');" id="delete_button" name="delete_button">
                                <img src="image/icons/user_delete.png" title="Delete Client" width="16" height="16"/>
                                </a>
                                <a href="recharge.php?customer_name=<?php echo $customer_name?>&profile=<?php echo $profile?>&sno=<?php echo $id?>&date_of_birth=<?php echo $date_of_birth?>&charges=<?php echo $charges?>&renewal=<?php echo $renewal?>"  id="recharge_button" name="recharge_button">
                                <img src="image/icons/user_recharge.png" title="Recharge" width="16" height="16"/>
                                </a>
