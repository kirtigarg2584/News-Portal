...
$query="insert into result (sno,result_text,profile_name,status,assigned_id) values('','$result_text','$profile_name','1','$new_id')";
...
$query1="insert into result_assign (sno,result_text,profile_name,assigned_id) values('','$result_text','$profile_group1','$new_id')";
