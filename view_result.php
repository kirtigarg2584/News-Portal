...
$query = "select DISTINCT result_text,profile_name,active_date,status,sno,assigned_id from result where AddBy='$user3'";
...
?>
							<tbody>
                                ...
                                <!--td align="center" width="5%"><?php //echo $active_date?></td-->
                                  <td align="center" width="5%"><a href="status_update_result.php?profile_name=<?php echo $profile_name?>&status=<?php echo $status?>&active_date=<?php echo $active_date?>&assigned_id=<?php echo $old_unique_id?>"><?php if($status == '1'){echo "Activated" ;}else{ echo "Deactivated" ;}?></a></a></td>
...
<?php } ?>
						...
						<?php 
							...
							echo "<a href='view_result.php?page=1'>".'|<'."</a> "; // Goto 1st page  

							for ($i=1; $i<=$total_pages; $i++) { 
										echo "<a href='view_result.php?page=".$i."'>".$i."</a> "; 
							}; 
							echo "<a href='view_result.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
						?>
