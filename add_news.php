...
$datevar         = date("Y-m-d h:i:s ");
 $query_update3 = "UPDATE news SET status = '0' , active_date = '$datevar' WHERE status = '1' ";
$result_update3 = mysql_query($query_update3) or die("Error in update3 query");
$user3 = $_SESSION['username'];
$query="insert into news(news,active_date,status,AddBy) values('$news',NOW(),1,'$user3')";
...
<div id="header">
	...
	<form action="add_news.php" method="post" id="myForm" onsubmit="return validate()">
		...
		<fieldset class="contact">
            ...
            <div>
               ...
               <textarea name="news" id="news" cols="30" rows="4"></textarea>
			</div>
...
{*/
?>
		<div>&nbsp;&nbsp;&nbsp;&nbsp;<input type="hidden" name="action_type" value="add_news"><input type="submit" value="Add News" name="add_news" id="add_news" />
<?php //}else{ ?>
