...
//echo "$aname";
$query="insert into metals (sno,metal_name,active_date,status) values('','$metal','$active_date','$status')";
...
<div id="header">
	...
	<form action="#" method="post">
		...
		<fieldset class="contact">
			<legend>Add Metal</legend>
            
			<div>
				<label for="metal">Add Metal</label> <input type="text" id="metal" name="metal">
			</div>
            </br></br></br></br></br>
